...
# -----------------------------------------------------------
AC_DEFUN([MCA_orcm_notifier_ftb_CONFIG], [
    AC_CONFIG_FILES([orcm/mca/notifier/ftb/Makefile])

    ORCM_CHECK_FTB([notifier_ftb],
