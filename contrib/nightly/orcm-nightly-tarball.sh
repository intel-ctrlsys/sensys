...
release_raw_uri=https://raw.github.com/open-mpi/orcm-release

# where to put built tarballs
outputroot=/l/osl/www/www.open-mpi.org/software/orcm/nightly
...
coverity_configure_args=--without-usnic
...
for branch in $branches; do
    ...
    if test ! $? -eq 0 ; then
        echo "wget of ORCM nightly tarball create script failed."
