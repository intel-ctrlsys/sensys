...
orcm_sst_base_component_t mca_sst_orcmsched_component = {
    {
        ORCM_SST_BASE_VERSION_1_0_0,
        .mca_component_name = "orcmsched",
...
static int component_query(mca_base_module_t **module, int *priority)
{
    if (ORTE_PROC_IS_CM && ORTE_PROC_IS_SCHEDULER) {
        *module = (mca_base_module_t*)&orcm_sst_orcmsched_module;
        *priority = 100;
        return ORCM_SUCCESS;
    }
