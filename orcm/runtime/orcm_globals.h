...
#define ORCM_GET_POWER_BUDGET_COMMAND        19
#define ORCM_GET_POWER_MODE_COMMAND          20
#define ORCM_GET_POWER_WINDOW_COMMAND        21
#define ORCM_GET_POWER_OVERAGE_COMMAND       22
#define ORCM_GET_POWER_UNDERAGE_COMMAND      23
