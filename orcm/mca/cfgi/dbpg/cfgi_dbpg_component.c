 ...
 */
orcm_cfgi_dbpg_component_t mca_cfgi_dbpg_component = {
    {
        {
        ...
        .mca_open_component = postgres_component_open,
        .mca_close_component = postgres_component_close,
        .mca_query_component = postgres_component_query,
        .mca_register_component_params = postgres_component_register
        },
        .base_data = {
...
static int postgres_component_query(mca_base_module_t **module, int *priority)
{
    ...
    if (NULL != mca_cfgi_dbpg_component.dbname &&
        NULL != mca_cfgi_dbpg_component.table &&
        NULL != mca_cfgi_dbpg_component.user &&
        NULL != mca_cfgi_dbpg_component.pguri) {
        *priority = 90;
        *module = (mca_base_module_t*)&orcm_cfgi_dbpg_module;
        return ORCM_SUCCESS;
    }
