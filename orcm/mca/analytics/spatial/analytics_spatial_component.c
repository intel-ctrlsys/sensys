 ...
 */
const char* orcm_analytics_spatial_component_version_string =
    "ORCM ANALYTICS spatial MCA component version " ORCM_VERSION;
 ...
 */
orcm_analytics_base_component_t mca_analytics_spatial_component = {
    {
        ORCM_ANALYTICS_BASE_VERSION_1_0_0,
        /* Component name and version */
        .mca_component_name = "spatial",
...
static orcm_analytics_base_module_t* component_create(void)
{
    mca_analytics_spatial_module_t* mod;

    mod = (mca_analytics_spatial_module_t*)malloc(sizeof(mca_analytics_spatial_module_t));
    if (NULL == mod) {
        ORTE_ERROR_LOG(ORTE_ERR_OUT_OF_RESOURCE);
        return NULL;
    }
    /* copy the APIs across */
    memcpy(mod, &orcm_analytics_spatial_module.api, sizeof(orcm_analytics_base_module_t));
