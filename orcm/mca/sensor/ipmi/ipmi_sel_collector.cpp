...
//////////////////////////////////////////////////////////////////////////////
// Public API
ipmi_sel_collector::ipmi_sel_collector(const char* hostname, const ipmi_credentials& credentials, sel_error_callback_fn_t callback, void* user_object)
...
ipmi_sel_collector::ipmi_sel_collector(const ipmi_sel_collector&)
...
ipmi_sel_collector::~ipmi_sel_collector()
{
...
bool ipmi_sel_collector::is_bad() const
{
...
bool ipmi_sel_collector::scan_new_records(sel_ras_event_fn_t callback)
{
...
void ipmi_sel_collector::conditionally_send_ras_event() const
{
...
void ipmi_sel_collector::build_current_request(uint16_t id)
{
...
void ipmi_sel_collector::report_ipmi_cmd_failure(uint16_t id)
{
    stringstream ss;
...
bool ipmi_sel_collector::test_for_ipmi_cmd_error(uint16_t id, int cmd_result, unsigned char ipmi_condition)
{
...
bool ipmi_sel_collector::execute_ipmi_get_sel_entry(uint16_t id)
{
...
bool ipmi_sel_collector::get_next_ipmi_sel_record(uint16_t id)
{
    ...
    current_record_ = new sel_record((const uint8_t*)current_sel_response_);
...
void ipmi_sel_collector::report_error(int level, const char* msg) const
{
