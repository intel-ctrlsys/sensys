...
#ifndef PERSIST_SEL_RECORD_ID_H
#define PERSIST_SEL_RECORD_ID_H
...
{
    public: // Public API
        persist_sel_record_id(const char* hostname, sel_error_callback_fn_t error_callback); // Agnostic constructor
        virtual ~persist_sel_record_id();
