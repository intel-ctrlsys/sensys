 ...
 */
orcm_notifier_smtp_component_t mca_notifier_smtp_component = {
    {
        {
...
static int smtp_register(void)
{
    ...
    mca_notifier_smtp_component.from_name = strdup("ORCM Notifier");
    ...
    mca_notifier_smtp_component.subject = strdup("ORCM Notifier");
    ...
    mca_notifier_smtp_component.body_prefix = strdup("The ORCM SMTP notifier wishes to inform you of the following message:\n\n");
                                ...
                                int *priority)
{
    ...
    *module = NULL;
    ...
    if (NULL == mca_notifier_smtp_component.to ||
        ...
        orte_show_help("help-orcm-notifier-smtp.txt", 
    ...
    *priority = 10;
    *module = (mca_base_module_t *)&orcm_notifier_smtp_module;
    return ORCM_SUCCESS;    
}
