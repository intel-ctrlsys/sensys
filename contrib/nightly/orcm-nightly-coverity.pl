...
my $coverity_project = "open-mpi%2Forcm";
...
# Expand the ORCM tarball, build it
...
if ($dry_run_arg) {
    ...
    safe_system(0, "curl --form token=$coverity_token_arg " .
                ...
                "--form file=\@$orcm_ver-analyzed.tar.bz2 " .
                "--form version=$orcm_ver " .
