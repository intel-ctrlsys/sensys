...
int orcm_sensor_base_select(void)
{
    ...
    orcm_sensor_base_component_t *component = NULL;
     ...
     */
    none_found = true;
    OPAL_LIST_FOREACH(cli, &orcm_sensor_base_framework.framework_components, mca_base_component_list_item_t) {
        component = (orcm_sensor_base_component_t *) cli->cli_component;
        ...
        tmp_module->module    = (orcm_sensor_base_module_t*)module;
