...
%build
%configure --with-platform=contrib/platform/intel/hillsboro/orcm-linux
%{__make} %{?_smp_mflags}
...
install -D -m 0644 contrib/database/models.py %{buildroot}%{_datarootdir}/db-schema/models.py
install -D -m 0644 contrib/database/orcmdb_psql.ini %{buildroot}%{_datarootdir}/db-schema/orcmdb_psql.ini
install -D -m 0644 contrib/database/pg_alert_runner.py %{buildroot}%{_datarootdir}/db-schema/pg_alert_runner.py
install -D -m 0644 contrib/database/pg_partition_helper.py %{buildroot}%{_datarootdir}/db-schema/pg_partition_helper.py
install -D -m 0644 contrib/database/psql_odbc_driver.ini %{buildroot}%{_datarootdir}/db-schema/psql_odbc_driver.ini
install -D -m 0644 contrib/database/schema_migration.ini %{buildroot}%{_datarootdir}/db-schema/schema_migration.ini
install -D -m 0644 contrib/database/setup_orcmdb.py %{buildroot}%{_datarootdir}/db-schema/setup_orcmdb.py
install -D -m 0644 contrib/database/schema_migration/env.py %{buildroot}%{_datarootdir}/db-schema/schema_migration/env.py
install -D -m 0644 contrib/database/schema_migration/README %{buildroot}%{_datarootdir}/db-schema/schema_migration/README
install -D -m 0644 contrib/database/schema_migration/script.py.mako %{buildroot}%{_datarootdir}/db-schema/schema_migration/script.py.mako
install -d %{buildroot}%{_datarootdir}/db-schema/schema_migration/versions
install -D -m 0644 contrib/database/schema_migration/versions/*.py -t %{buildroot}%{_datarootdir}/db-schema/schema_migration/versions/
cd %{buildroot}
chmod -R +r *
...
%{_prefix}/share/openmpi/amca-param-sets
...
%{_prefix}/share/db-schema/models.py*
%{_prefix}/share/db-schema/orcmdb_psql.ini
%{_prefix}/share/db-schema/pg_alert_runner.py*
%{_prefix}/share/db-schema/pg_partition_helper.py*
%{_prefix}/share/db-schema/psql_odbc_driver.ini
%{_prefix}/share/db-schema/schema_migration.ini
%{_prefix}/share/db-schema/setup_orcmdb.py*
%dir %{_prefix}/share/db-schema/schema_migration
%{_prefix}/share/db-schema/schema_migration/env.py*
%{_prefix}/share/db-schema/schema_migration/README
%{_prefix}/share/db-schema/schema_migration/script.py.mako
%dir %{_prefix}/share/db-schema/schema_migration/versions
%{_prefix}/share/db-schema/schema_migration/versions/0fb66069a81f_schema_cleanup_removing_unused_tables.py*
%{_prefix}/share/db-schema/schema_migration/versions/13fcd621c9d5_increased_data_sample_raw_value_str_.py*
%{_prefix}/share/db-schema/schema_migration/versions/1d10ef20817b_creating_views_for_req_29_c.py*
%{_prefix}/share/db-schema/schema_migration/versions/241f4694b528_initial_version.py*
%{_prefix}/share/db-schema/schema_migration/versions/27089c78df35_update_function_generate_partition.py*
%{_prefix}/share/db-schema/schema_migration/versions/36357b09c750_added_inventory_timestamp.py*
%{_prefix}/share/db-schema/schema_migration/versions/3f96c40b580a_created_event_schema.py*
%{_prefix}/share/db-schema/schema_migration/versions/6c37dbeff9c1_create_event_view.py*
%{_prefix}/share/db-schema/schema_migration/versions/6dccea132086_views_for_req_23g.py*
%{_prefix}/share/db-schema/schema_migration/versions/6ff60a50de68_updated_view_col_types.py*
%{_prefix}/share/db-schema/schema_migration/versions/8437cd6e3578_updating_value_str_in_data_sample_raw_.py*
%{_prefix}/share/db-schema/schema_migration/versions/d109117b1990_functions_for_queries.py*
%{_prefix}/share/db-schema/schema_migration/versions/d79399c4d070_updating_all_value_str_to_text_from_.py*
%{_prefix}/share/db-schema/schema_migration/versions/f6d80b502c89_update_syslog_view_css_2562.py*
...
%{_prefix}/include/openmpi/opal/class
...
%{_prefix}/include/openmpi/opal/datatype
...
%{_prefix}/include/openmpi/opal/errhandler
...
%{_prefix}/include/openmpi/orcm/common/sensorInterface.h
