    ...
    {
        {
            ...
            orcm_pwrmgmt_manualfreq_open,  /* component open  */
            orcm_pwrmgmt_manualfreq_close, /* component close */
            orcm_pwrmgmt_manualfreq_query,  /* component query */
            manualfreq_component_register
        },
        {
