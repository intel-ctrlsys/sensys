...
static int orcmsd_init(void)
{
    ...
    */
    ...
    if (!ORTE_PROC_IS_HNP && NULL == getenv(OPAL_MCA_PREFIX"state")) {
        putenv(OPAL_MCA_PREFIX"state=orted");
    }
    ...
    /* Routed system */
    if (NULL == getenv(OPAL_MCA_PREFIX"routed")) {
        putenv(OPAL_MCA_PREFIX"routed=radix");
    }
