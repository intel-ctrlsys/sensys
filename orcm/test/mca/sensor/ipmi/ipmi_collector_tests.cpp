...
{
    ipmiCollector c(Hostname, BmcAddress, Aggregator, User, Pass, AuthMethod,
                    PrivLevel, ORCM_ERROR, ORCM_ERROR);
    ipmiCollector *cPtr = new ipmiCollector(Hostname, BmcAddress, Aggregator, User,
                                            Pass, AuthMethod, PrivLevel,
                                            ORCM_ERROR, ORCM_ERROR);
    ASSERT_TRUE(NULL != cPtr);
