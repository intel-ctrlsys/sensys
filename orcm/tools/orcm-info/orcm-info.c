...
int main(int argc, char *argv[])
{
    ...
    opal_cmd_line_make_opt3(orcm_info_cmd_line, 'v', NULL, "version", 2,
                            "Show version of ORCM or a component.  The first parameter can be the keywords \"orcm\" or \"all\", a framework name (indicating all components in a framework), or a framework:component string (indicating a specific component).  The second parameter can be one of: all, full, major, minor, release, greek, svn.");
