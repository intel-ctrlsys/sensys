    ...
    {
        {
            ...
            orcm_sensor_nodepower_open,  /* component open  */
            orcm_sensor_nodepower_close, /* component close */
            orcm_sensor_nodepower_query,  /* component query */
            nodepower_component_register
        },
        {
