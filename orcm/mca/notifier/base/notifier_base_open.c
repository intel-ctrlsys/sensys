 ...
 * Global variables
 */
int orcm_notifier_base_framework.framework_output = -1;
...
int orte_notifier_base_open(void)
{
    ...
    orcm_notifier_base_framework.framework_output = opal_output_open(NULL);
    ...
    if (ORTE_SUCCESS !=
        mca_base_components_open("notifier", orcm_notifier_base_framework.framework_output,
