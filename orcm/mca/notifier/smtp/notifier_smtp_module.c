...
/* Module */
orcm_notifier_base_module_t orcm_notifier_smtp_module = {
    NULL,
    NULL,
    mylog,
    myhelplog,
...
static int send_email(char *msg)
{
    ...
    message_status_t ms;
    orcm_notifier_smtp_component_t *c = &mca_notifier_smtp_component;
