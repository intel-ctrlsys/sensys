...
static void command_log(orcm_notifier_base_severity_t severity, int errcode, 
                        const char *msg, va_list ap);
static void command_help(orcm_notifier_base_severity_t severity, int errcode, 
                         const char *filename, 
                         const char *topic, va_list ap);
static void command_peer(orcm_notifier_base_severity_t severity, int errcode, 
                         orte_process_name_t *peer_proc,
                         const char *msg, va_list ap);

/* Module */
orcm_notifier_base_module_t orcm_notifier_command_module = {
    NULL,
    NULL,
    command_log,
    command_help,
